...
mod tests {
    ...
    // DEBUG: Temporarily un-ignored to debug AMD AVX SIGILL issue
    // See: https://github.com/maplibre/maplibre-tile-spec/issues/1016
    // Original: #[ignore = "FIXME - executes AVX (?) code despite neither using inline assembly. Maybe UB. Does only happen on AMD Server CPUs"]
